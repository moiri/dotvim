...
exec 'nmap <buffer> <silent> ' . g:sparkupExecuteMapping . ' :call <SID>Sparkup()<cr>'
exec 'imap <buffer> <silent> ' . g:sparkupExecuteMapping . ' <c-g>u<Esc>:call <SID>Sparkup()<cr>'
exec 'nmap <buffer> <silent> ' . g:sparkupNextMapping . ' :call <SID>SparkupNext()<cr>'
exec 'imap <buffer> <silent> ' . g:sparkupNextMapping . ' <c-g>u<Esc>:call <SID>SparkupNext()<cr>'
exec 'nmap <buffer> <silent> ' . g:sparkupPreviousMapping . ' :call <SID>SparkupPrevious()<cr>'
exec 'imap <buffer> <silent> ' . g:sparkupPreviousMapping . ' <c-g>u<Esc>:call <SID>SparkupPrevious()<cr>'
