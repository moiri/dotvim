...
nnoremap <leader>G :grep -R --exclude=*.swp --exclude-dir=.git --exclude-dir=doc --exclude-dir=node_modules --exclude-dir=build "<C-r>=expand('<cword>')<CR>" .
xnoremap <leader>G :grep -R --exclude=*.swp --exclude-dir=.git --exclude-dir=doc --exclude-dir=node_modules --exclude-dir=build "<C-r>=functions#GetVisualSelection()<CR>" .
nnoremap <leader>g :grep --exclude=*.swp --exclude-dir=.git --exclude-dir=doc --exclude-dir=node_modules --exclude-dir=build "<C-r>=expand('<cword>')<CR>" .
xnoremap <leader>g :grep --exclude=*.swp --exclude-dir=.git --exclude-dir=doc --exclude-dir=node_modules --exclude-dir=build "<C-r>=functions#GetVisualSelection()<CR>" .
